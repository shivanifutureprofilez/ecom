...
const Newsletter = () => {
    return (
        <div className='max-w-9xl place-self-center items-left mt-6 '>
                <div className='bg-[#f5f5f5] max-w md:max-w-6xl flex justify-between items-center gap-4 px-6 py-6 mt-8 mb-8'>
                    <div>
                        ...
                        <div class="mt-4 lg:mt-6 sm:flex">
                            ...
                            <button class="bg-black h-12 bg-title text-white flex items-center justify-center text-sm md:text-lg font-medium p-3 mt-3 sm:mt-0 sm:w-32 sm:h-auto sm:flex-none dark:bg-primary dark:text-white">Subscribe</button>
                        </div>
                    </div>
                    <div className='mt-2 py-2 hidden md:block'>
