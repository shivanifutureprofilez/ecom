...
export const Importance = () => {
  return (
    <div className='bg-[#f5f5f5] dark:bg-dark-secondary py-10 px-5 md:px-7 lg:px-16 xl:px-24 xl:pb-24 sm:pt-0 max-w-8xl  mx-auto pb-0'>
    <div className='bg-[#f5f5f5] s-py-100 max-w-8xl display:flex-center left-0 right-0 pl-0'>
        <div className=' border-b border-bdr-clr dark:border-bdr-clr-dark'>
          <h6 className='font-semibold text-[24px] md:text-3xl text-center  sm:text-left mt-4 p-0 pt-12 mx-5'>Why You Choose Us</h6><br/>
          {/* upper border line */}
    ...
    <div className='bg-[#f5f5f5] s-py-100 max-w-8xl display:flex-center left-0 right-0 pl-5'>
        <div className="flex flex-col md:flex-row items-stretch justify-center divide-x divide-dashed divide-gray-300 pb-20">
          ...
          <div className="flex-1 px-6 text-center md:text-left  border-b border-bdr-clr dark:border-bdr-clr-dark  ">
            <CiDeliveryTruck className="text-3xl text-yellow-700 mb-4 mx-auto md:mx-0 mt-7" />
          ...
          <div className="flex-1 px-6 text-center md:text-left border-b border-bdr-clr dark:border-bdr-clr-dark ">
            <GiReturnArrow className="text-3xl text-yellow-700 mb-4 mx-auto md:mx-0 mt-7" />
          ...
          <div className="flex-1 px-6 text-center md:text-left border-b border-bdr-clr dark:border-bdr-clr-dark ">
            <MdOutlinePayment className="text-3xl text-yellow-700 mb-4 mx-auto md:mx-0 mt-7" />
          ...
          <div className="flex-1 px-6 text-center md:text-left border-b border-bdr-clr dark:border-bdr-clr-dark">
            <RiCustomerService2Fill className="text-3xl text-yellow-700 mb-4 mx-auto md:mx-0 mt-7" />
            <h5 className="font-semibold text-xl md:text-lg">Fast Delivery</h5>
            <p className="mt-2 text-xs text-gray-700 mb-2">
